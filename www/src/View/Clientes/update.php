...
<form id="form-edit-funcionario" method="post">
      ...
      <div class="row">
        <div class="col-4 mb-3">
          ...
          <input required maxlength="255" type="text" class="form-control" id="Nome" name="ds_nome" placeholder="Digite o nome do funcionario" value="<?= $funcionario->getNome()?>">
        </div>
        <div class="col-4 mb-3">
          <label for="CPF" class="form-label">CPF:</label>
          <input required type="text" maxlength="11" class="form-control" id="CPF" name="ds_cpf" placeholder="Digite o cpf do funcionario" value="<?= $funcionario->getCpf()?>">
        </div>
        <div class=" col-4 mb-3">
      ...
      <div class="row">
        <div class="col-6 mb-3">
          ...
          <input required maxlength="255" type="email" class="form-control" id="Email" name="ds_email" placeholder="Digite o Email do funcionario" value="<?= $funcionario->getEmail()?>">
        </div>
        <div class="col-6 mb-3">
        <label for="estado-civil" class="form-label">Estado civil:</label>
          ...
          <?php foreach($arrEstadocivil as $estadocivil): 
            $selected = $estadocivil->getEstadoCivil() == $funcionario->getEstadoCivil() ? 'selected' : '';
            ?>
